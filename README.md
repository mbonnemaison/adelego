...
**Adelego** is a project which aims to help caregivers & people with dependence live longer and more safely at home.
...
For both questions, the goal was to provide the mean, standard deviation and a graph that shows the mean and standard deviations away from the mean. Below are the graphs summarizing our analysis. On both graphs, the red line represents the average and the green lines are located 1 standard deviation away from the average.
